...
There are some major changes that have been made since v1. 
In the first iteration since we focused on end-to-end
...
platform, but not that much. To easily view and read data from our
multi-tier smartcontact system, checkout the documentation for MatryxExplorer.
